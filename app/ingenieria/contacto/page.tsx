...
export default function IngenieriaContactoPage() {
    ...
    <section className="section-padding bg-white">
      <div className="container-custom mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 max-w-2xl text-steel-600">
          Para consultas sobre ingeniería, complete el formulario o utilice los datos de contacto.
        </p>
        ...
        <div className="mt-12">
          <Link href="/ingenieria/cotizacion" className="font-medium text-accent hover:underline">Solicitar cotización →</Link>
        </div>
      </div>
    </section>
  );
