...
export default function IngenieriaCotizacionPage() {
  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <h1 className="heading-1">Solicitar cotización</h1>
        <p className="mt-4 text-steel-600">
          Describa su proyecto de ingeniería y le enviaremos una propuesta sin compromiso.
        </p>

        {sent ? (
          <div className="mt-12 rounded-xl border border-steel-200 bg-steel-50/50 p-8 text-center">
            <p className="text-steel-700">
              Hemos recibido su solicitud. Nos pondremos en contacto a la brevedad con una cotización.
            </p>
            <Link href="/ingenieria" className="mt-6 inline-block text-accent font-medium hover:underline">
              Volver al inicio
            </Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="mt-12 space-y-6 rounded-xl border border-steel-200 bg-white p-6 shadow-sm">
            ...
            <div>
              ...
              <select id="service" name="service" className="mt-1 w-full rounded-lg border border-steel-300 px-3 py-2 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent">
                ...
                <option value="metalmecanica">Ingeniería metalmecánica</option>
            ...
            <div>
              ...
              <textarea id="message" name="message" rows={5} required className="mt-1 w-full rounded-lg border border-steel-300 px-3 py-2 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent" placeholder="Describa brevemente el proyecto, plazos estimados y cualquier requisito especial." />
            </div>
            <button type="submit" className="w-full rounded-lg bg-accent px-4 py-3 font-medium text-white hover:bg-accent-light">
              Enviar solicitud
            </button>
          </form>
        )}
