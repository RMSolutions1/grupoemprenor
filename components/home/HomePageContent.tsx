...
interface HomePageContentProps {
  /** Servicios desde BD; si viene vacío o null, ServiceCards usa constantes */
  services?: ServiceCardItem[] | null;
  /** Proyectos destacados (desde BD o estáticos); siempre se pasa desde el servidor */
  featuredProjects: ProjectItem[];
}

export function HomePageContent({ services, featuredProjects }: HomePageContentProps) {
  return (
    <>
      <HeroSection
      ...
      <section className="section-padding bg-steel-50">
        <div className="container-custom">
          ...
          <div className="mt-12">
            <ServiceCards services={services ?? undefined} />
          </div>
        </div>
      </section>
